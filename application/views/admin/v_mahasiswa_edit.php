        ...
        <div class="card">
          ...
          <form action="<?php echo site_url('admin/mahasiswa/proses_edit'); ?>" method="post">
            <div class="form-group">
              <label>NIM</label>
              <input class="form-control" name="nim" value="<?php echo $isi_data->nim; ?>"></input>
            </div>
            <div class="form-group">
              <label>Nama Mahasiswa</label>
              <input class="form-control" name="nama_mahasiswa"  value="<?php echo $isi_data->nama_mahasiswa ?>"></input>
            </div>
            <div class="form-group">
